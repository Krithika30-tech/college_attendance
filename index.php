        ...
        <table class="attend-table">
          ...
          <?php while($row = mysqli_fetch_assoc($students)): ?>
            <tr>
              ...
              <td style="color:var(--muted); font-family:'DM Mono',monospace; font-size:13px">
              ...
              <td>
                <div class="radio-group">
                  ...
                  <label class="radio-label">
                    <input type="radio" name="attendances3[<?= $row['id'] ?>]" value="Absent">
                  ...
                  <label class="radio-label">
                    <input type="radio" name="attendances3[<?= $row['id'] ?>]" value="Leave">
